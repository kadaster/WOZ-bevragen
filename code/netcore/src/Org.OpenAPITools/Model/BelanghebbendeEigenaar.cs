...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BelanghebbendeEigenaar")]
    public partial class BelanghebbendeEigenaar : IEquatable<BelanghebbendeEigenaar>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BelanghebbendeEigenaar" /> class.
        /// </summary>
        ...
        public BelanghebbendeEigenaar(string burgerservicenummer = default(string), bool geheimhoudingPersoonsgegevens = default(bool), string kvkNummer = default(string), string naam = default(string), string rsin = default(string), PersoonTypeEnum type = default(PersoonTypeEnum), string vestigingsnummer = default(string), string soort = default(string))
        {
        ...
        {
            return this.Equals(input as BelanghebbendeEigenaar);
        }

        /// <summary>
        /// Returns true if BelanghebbendeEigenaar instances are equal
        /// </summary>
        /// <param name="input">Instance of BelanghebbendeEigenaar to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BelanghebbendeEigenaar input)
        {
            if (input == null)
                return false;
