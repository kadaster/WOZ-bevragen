...
namespace Org.OpenAPITools.Model
{
    ...
    /// ObjectAanduiding
    /// </summary>
    [DataContract(Name = "ObjectAanduiding")]
    public partial class ObjectAanduiding : IEquatable<ObjectAanduiding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectAanduiding" /> class.
        /// </summary>
        ...
        public ObjectAanduiding(string straat = default(string), int huisnummer = default(int), string huisletter = default(string), string huisnummertoevoeging = default(string), string postcode = default(string), string woonplaats = default(string), string locatieomschrijving = default(string), string nummeraanduidingIdentificatie = default(string))
        {
            this.Straat = straat;
        ...
        {
            return this.Equals(input as ObjectAanduiding);
        }

        /// <summary>
        /// Returns true if ObjectAanduiding instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectAanduiding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectAanduiding input)
        {
            if (input == null)
                return false;
